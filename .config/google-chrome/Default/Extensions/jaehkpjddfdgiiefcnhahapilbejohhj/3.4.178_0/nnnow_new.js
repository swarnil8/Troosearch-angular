...
pidFlipkart = getPID();
var selector = [];
selector.push({selector: '.fnl-pdp-prodDetails:eq(0)', attr: 'parent', pos: 'after'});
selector.push({selector: '.fnl-pdp-container:eq(0)', attr: 'none', pos: 'after'});
