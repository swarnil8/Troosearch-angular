...
// https://cheapfaresindia.makemytrip.com/international/raw/index.html?l=exIndia&t=MC&i=BLR-JNB-D-19Jan2017_BOM-GOI-D-10Apr2017&p=A-1&c=E&userID=90141482130503475#/listing
...
var posSpecs = [];
posSpecs.push({selector: 'body', attr: 'none', cssAttr: 'top', preVal: '46px', postVal: '0'});
posSpecs.push({selector: '.ch__bodyWrapper', attr: 'none', cssAttr: 'margin-top', preVal: '46px', postVal: '0px'});
...
function checkFlightBarPos(){
  ...
  if($(".hk-compBar").length > 0 && $(".ch__bodyWrapper").length > 0){
    $(".ch__bodyWrapper").css("margin-top", "46px");
    $("body").css("top", "46px");
  }
  else{
