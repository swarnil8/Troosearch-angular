...
function sendPairs(){
  ...
  if($('#freq .personalisegridLayout').length > 0){
    var slider = $('#freq .personalisegridLayout');
    var sliderLength = slider.length;
    var link;
    var price;
    var PID;
    ...
    for(i=0;i<sliderLength;i++){
      PID = "";
      price = "";
      if($('#freq .personalisegridLayout:eq('+ i +')').find('a').length > 0){
        link = $('#freq .personalisegridLayout:eq('+ i +')').find('a:eq(0)').attr('href');
        ////console.log(link);
        if(link != ""){ 
          if(link.split("#").length > 1)  {
            link = link.split("#")[0];
        ...
        if(PID != ""){
          if($('#freq .personalisegridLayout:eq('+ i +')').find('.product-price').length > 0){
            if($('#freq .personalisegridLayout:eq('+ i +')').find('.product-price #price').length > 0){
              price = $('#freq .personalisegridLayout:eq('+  i +')').find('.product-price #price').text();
              if(price.split("Rs").length > 1){
                price = price.split("Rs");
                price = price[1];
              }
            }
            else if($('#freq .personalisegridLayout:eq('+ i +')').find('.product-price strike').length > 0){
              if($('#freq .personalisegridLayout:eq('+  i +')').find('.product-price').html().split('</strike>').length > 1){
                price = $('#freq .personalisegridLayout:eq('+  i +')').find('.product-price').html().split('</strike>')[1];
                if(price.split("Rs").length > 1){
                  price = price.split("Rs");
                  price = price[1];
                }
              ...
              price = $('#freq .personalisegridLayout:eq('+ i +')').find('.product-price').text();
            }
            if(price.split("Rs").length > 1){
              price = price.split("Rs");
              price = price[1];
  ...
  if($('.recViewedProductWrapper').length > 0){
    var slider = $('.recViewedProductWrapper');
    var sliderLength = slider.length;
    var link;
    var price;
    var PID;
    ...
    for(i=0;i<sliderLength;i++){
      PID = "";
      price = "";
      if($('.recViewedProductWrapper:eq('+ i +')').find('a').length > 0){
        link = $('.recViewedProductWrapper:eq('+ i +')').find('a:eq(0)').attr('href');
        ////console.log(link);
        if(link != ""){ 
          if(link.split("#").length > 1)  {
            link = link.split("#")[0];
        ...
        if(PID != ""){
          if($('.recViewedProductWrapper:eq('+ i +')').find('.recViewedProduct-price').length > 0){
            if($('.recViewedProductWrapper:eq('+ i +')').find('.recViewedProduct-price span').length > 0){
              if($('.recViewedProductWrapper:eq('+  i +')').find('.recViewedProduct-price').html().split('</span>').length > 1){
                price = $('.recViewedProductWrapper:eq('+  i +')').find('.recViewedProduct-price').html().split('</span>')[1];
                if(price.split("Rs").length > 1){
                  price = price.split("Rs");
                  price = price[1];
                }
              ...
              price = $('.recViewedProductWrapper:eq('+ i +')').find('.recViewedProduct-price').text();
            }
            if(price.split("Rs").length > 1){
              price = price.split("Rs");
              price = price[1];
  ...
  if($('.smallGridLayout').length > 0){
    var slider = $('.smallGridLayout');
    var sliderLength = slider.length;
    var link;
    var price;
    var PID;
    ...
    for(i=0;i<sliderLength;i++){
      PID = "";
      price = "";
      if($('.smallGridLayout:eq('+ i +')').find('a').length > 0){
        link = $('.smallGridLayout:eq('+ i +')').find('a').attr('href');
        ////console.log(link);
        if(link != ""){ 
          if(link.split("#").length > 1)  {
            link = link.split("#")[0];
        ...
        if(PID != ""){
          if($('.smallGridLayout:eq('+ i +')').find('.product-price').length > 0){
            if($('.smallGridLayout:eq('+ i +')').find('.product-price strike').length > 0){
              if($('.smallGridLayout:eq('+  i +')').find('.product-price').html().split('</strike>').length > 1){
                price = $('.smallGridLayout:eq('+  i +')').find('.product-price').html().split('</strike>')[1];
                if(price.split("Rs").length > 1){
                  price = price.split("Rs");
                  price = price[1];
                }
              ...
              price = $('.smallGridLayout:eq('+ i +')').find('.product-price').text();
            }
            if(price.split("Rs").length > 1){
              price = price.split("Rs");
              price = price[1];
  ...
  if($('#products-main .product_list_view_cont').length > 0){
    var slider = $('#products-main .product_list_view_cont');
    var sliderLength = slider.length;
    var link;
    var price;
    var PID;
    ...
    for(i=0;i<sliderLength;i++){
      PID = "";
      price = "";
      if($('#products-main .product_list_view_cont:eq('+ i +')').find('a').length > 0){
        link = $('#products-main .product_list_view_cont:eq('+ i +')').find('a:eq(0)').attr('href');
        ////console.log(link);
        if(link != ""){ 
          if(link.split("#").length > 1)  {
            link = link.split("#")[0];
        ...
        if(PID != ""){
          if($('#products-main .product_list_view_cont:eq('+ i +')').attr('price').length > 0){
            price = $('#products-main .product_list_view_cont:eq('+ i +')').attr('price');
          }
        }
...
function sendCurrent(){
  ...
  if($('.noLongerProduct').length > 0){
    current_status = 1;
  }
  else if($(".notifyMe-soldout").css("display") == "block"){
    current_status = 1;
  }
  else{
    current_status = 0;
  ...
  if($("#selling-price-id").length > 0){ 
    myPrice = $("#selling-price-id").text();
  }
  else if($(".selling-price").length > 0)
  {
    if($(".selling-price").find(".pdp_newprice").length > 0){
      myPrice = $(".selling-price").find(".pdp_newprice").text();
    }
  ...
  else if($("#mrp").length > 0)
  {
    ...
    if($("#mvfrstVisible").find(".redText").length > 0){
      myPrice = $("#mvfrstVisible").find(".redText:eq(0)").text();
    }
...
$('.hatke-discount-cover:eq(0)').css("display", "block");
  var httpq4 = new getXMLHTTPRequest();
  var ext_id, ext_auth;
  chrome.runtime.sendMessage({getCoupons: 3}, function(response) {
    });

    chrome.runtime.onMessage.addListener(
    function(request, sender) {
    var mytext = request.coupons;
...
if($('.prodbuy-button').length>0){
  if(flagToDisp==0){
    //console.log("Entered furst case");
